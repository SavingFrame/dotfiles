    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject background: JsonObject {
                ...
                property string slideshowFolder: StandardPaths.writableLocation(StandardPaths.PicturesLocation) + "/wallpapers"
                property int slideshowInterval: 900000 // 15 minutes in ms
                property string slideshowOrder: "random" // "random" or "sequential"
            }
