...
}:
{
  ...
  services.swaync = {
      ...
      widget-config = {
        ...
        buttons-grid = {
          actions = [
            ...
            {
              label = "󰈙";
              command = "ghostty -e bash -i -c 'Docs'";
            }
            {
              label = "";
              command = "ghostty -e bash -i -c 'Settings'";
            }
            {
              label = "";
              command = "ghostty -e bash -i -c 'tasks'";
            }
            {
              label = "";
              command = "hyprlock";
    ...
    style = ''
      @define-color foreground #c2c0c0;
      @define-color background #0c0505;
      @define-color cursor #c2c0c0;
      @define-color color0 #0c0505;
      @define-color color1 #656565;
      @define-color color2 #727272;
      @define-color color3 #7e7e7e;
      @define-color color4 #898989;
      @define-color color5 #969696;
      @define-color color6 #a0a0a0;
      @define-color color7 #958989;
      @define-color color8 #675555;
      @define-color color9 #878787;
      @define-color color10 #989898;
      @define-color color11 #A9A9A9;
      @define-color color12 #B7B7B7;
      @define-color color13 #C8C8C8;
      @define-color color14 #D6D6D6;
      @define-color color15 #c2c0c0;
